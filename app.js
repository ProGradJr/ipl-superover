...
function gameOver() {
  if (team1Score > team2Score) $winnerBox.textContent = "MI wins";
  if (team2Score > team1Score) $winnerBox.textContent = "DC wins";
  if (team2Score === team1Score)
    $winnerBox.textContent = "It is another superover!";
  console.log("foo");
...
strikeButton.onclick = () => {
  ...
  updateScore();
  console.log(team1Score, team1Wickets, team2Score, team2Wickets);
};
